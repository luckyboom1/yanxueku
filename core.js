...
const APP_VERSION = 'v3.0.0-beta.9';   // v3.0.0-beta.9: 中外新闻史科目扩充（+316 张史实卡，共 328）   // v3.0.0-beta.8: 复习页支持按科目选择复习范围   // v3.0.0-beta.7: 公共课程库新增「前沿名词解释」（15 科 1084 卡）   // v3.0.0-beta.6: 公共课程库新增「高频名词解释」（14 科 832 卡）
      ...
      '<div class="gate-card">'+
        ...
        '<div class="gate-features gate-stagger">'+
          ...
          '<div class="gate-feat" data-tip="13大热门考研专业课\n616张真实知识点卡片\n打开即用，无需手动录入">'+
            '<div class="gf-icon">📚</div><span>15科1394卡片</span></div>'+
      ...
      '<div class="gate-features-section">'+
        ...
        '<div class="gate-showcase">'+
          ...
          '<div class="gate-showcase-card" style="--i:1">'+
            ...
            '<ul><li>15大热门考研专业 · 1394张预置卡片</li><li>公共课程库一键导入到个人科目</li><li>单张创建 / 文本批量导入 / 卡包分享</li></ul>'+
          '</div>'+
          // 功能3: 刷题自测
